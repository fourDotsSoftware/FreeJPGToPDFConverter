...
;copy translations end
  ...
  !define MUI_FILE "FreeJPGToPDFConverter"
  !define MUI_VERSION ""
  !define MUI_PRODUCT "Free JPG to PDF Converter"
  !define PRODUCT_SHORTCUT "Free JPG to PDF Converter"
  !define PRODUCT_VERSION "1.2"
  
  !define MUI_ICON "free-jpg-to-pdf-converter-48.ico"
...
;  !define MUI_FINISHPAGE_SHOWREADME "$INSTDIR\readme.txt"
  ...
  OutFile "FreeJPGToPDFConverterSetup.exe"

  InstallDir "$PROGRAMFILES\4dots Software\${PRODUCT_SHORTCUT}"

  InstallDirRegKey HKLM "Software\4dots Software\Free JPG to PDF Converter" ""
...
;create start-menu items
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_SHORTCUT}\Free JPG to PDF Converter - User's Manual.url.lnk" "$INSTDIR\Free JPG to PDF Converter - User's Manual.url" "" "$INSTDIR\Free JPG to PDF Converter - User's Manual.url" 0
...
;Add files
 ...
 Call IsDotNetInstalledAdv
  ...
  File "Free JPG to PDF Converter - User's Manual.url";
...
;write uninstall information to the registry
 ...
 ;Store installation folder
  WriteRegStr HKLM "Software\4dots Software\Free JPG to PDF Converter" "" $INSTDIR
  WriteRegStr HKLM "Software\4dots Software\Free JPG to PDF Converter" "InstallationDirectory" $INSTDIR
...
!endif
  ...
  !insertmacro UnInstallLib REGDLL NOTSHARED NOREBOOT_NOTPROTECTED $SYSDIR\FreeJPGToPDFConverterExt64.dll
  SetRegView 64
   SetShellVarContext all
; 64bit things here
...
; 32bit things here
  ...
  !insertmacro UnInstallLib REGDLL NOTSHARED NOREBOOT_NOTPROTECTED $SYSDIR\FreeJPGToPDFConverterExt32.dll
...
;Delete Uninstaller And Unistall Registry Entries
  ...
  DeleteRegKey HKLM "Software\4dots Software\Free JPG to PDF Converter"
  DeleteRegKey HKCU "Software\4dots Software\Free JPG to PDF Converter"
...
Function .onInstSuccess
 ...
 ExecShell "" "https://www.4dots-software.com/free-jpg-to-pdf-converter/how-to-use.php?afterinstall=true&version=${PRODUCT_VERSION}";
...
Function OpenWebpageFunction
  ExecShell "" "http://www.4dots-software.com/free-jpg-to-pdf-converter/how-to-use.php?afterinstall=true"
FunctionEnd
