    ...
    class TranslateHelper
    {
        ...
        public static string Translate(string str)
        {
            if (rm == null)
            {
                ...
                rm = new System.Resources.ResourceManager("FreeJPGToPDFConverter.ResTranslate", cm.GetType().Assembly);
            ...
            {
                TranslateHelper cm = new TranslateHelper();
                rm2 = new System.Resources.ResourceManager("FreeJPGToPDFConverter.ResTranslate", cm.GetType().Assembly);
            }
