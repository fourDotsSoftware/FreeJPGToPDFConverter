...
namespace FreeJPGToPDFConverter
{
    class Module
    {
        ...
        public static string ApplicationName = "Free JPG to PDF Converter";
        ...
        public static string DownloadURL = "https://www.4dots-software.com/d/FreeJPGToPDFConverter/";
        public static string HelpURL = "https://www.4dots-software.com/free-jpg-to-pdf-converter/how-to-use.php";
        public static string ProductWebpageURL = "https://www.4dots-software.com/free-jpg-to-pdf-converter/";
        public static string BuyURL = "https://www.4dots-software.com/store/buy-free-jpg-to-pdf-converter.php";
        public static string VersionURL = "http://cssspritestool.com/versions/free-jpg-to-pdf-converter.txt";

        public static string TipText = TranslateHelper.Translate("Great application to convert JPG and other Images to PDF !");
        ...
        public static string TempFolder
        {
            get
            {
                string path = System.IO.Path.Combine(System.IO.Path.GetTempPath(), "FreeJPGToPDFConverter");
