...
namespace FreeJPGToPDFConverter
{
    class RecentFilesHelper
    {
        ...
        */
        ...
        public static void FillRecentOutputFile()
        {
            //2
            /*
            string[] str = Properties.Settings.Default.RecentOutputFiles.Split(new string[] { "|||" }, StringSplitOptions.RemoveEmptyEntries);

            for (int k = 0; k < str.Length; k++)
            {
                frmMain.Instance.cmbOutputDir.Items.Add(str[k]);
            }*/
        }
        ...
        public static void AddRecentOutputFile(string filepath)
        {
            string[] str = Properties.Settings.Default.RecentOutputFiles.Split(new string[] { "|||" }, StringSplitOptions.RemoveEmptyEntries);
            ...
            int ck=frmMain.Instance.cmbOutputDir.Items.Count;
            ...
            */
            ...
            //3frmMain.Instance.cmbOutputDir.Items.Clear();
            ...
            for (int k = 0; k < strl.Count && k <= 12; k++)
            {
                frmMain.Instance.cmbOutputDir.Items.Add(strl[k]);
                newrec += strl[k] + "|||";
            }
            */

            Properties.Settings.Default.RecentOutputFiles = newrec;

            //2frmMain.Instance.cmbOutputDir.SelectedIndex = 0;
        }
